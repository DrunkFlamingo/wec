...
dwarfs:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
high_elves:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
empire:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
norsca:add_option("yeild", "Vanilla", "Allow any faction of this race to confederate through defeating faction leaders")
...
vamps:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
def:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
Lizardmen:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
Skaven:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
...
Greenskins:add_option("true", "Vanilla", "Allow any faction of this race to confederate")
